...
class NodeWrapperGenerator(object):
    def __init__(self):
        self.clear()
...
#            self.gen_const_reg(constinfo)
        ...
        self.save(output_path, "node_opencv_generated_include.h", self.code_include)
        self.save(output_path, "node_opencv_generated_funcs.h", self.code_funcs)
        self.save(output_path, "node_opencv_generated_types.h", self.code_types)
        self.save(output_path, "node_opencv_generated_type_reg.h", self.code_type_reg)
        self.save(output_path, "node_opencv_generated_ns_reg.h", self.code_ns_reg)
...
if __name__ == "__main__":
    ...
    generator = NodeWrapperGenerator()
